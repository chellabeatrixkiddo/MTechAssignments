...
p4 <- plot_ly(income1, labels = income2$`Complaint Type`, values = income2$`Sr. No`, type = 'pie') %>%
...
p5 <- plot_ly(income1, labels = income3$`Complaint Type`, values = income3$`Sr. No`, type = 'pie') %>%
